...
import type { LoginCredentials, FakeStoreLoginResponse, FakeStoreUser, User } from '../types/auth'

// API base URL
const API_BASE_URL = 'https://fakestoreapi.com'

// API functions
export const loginUser = async (credentials: LoginCredentials): Promise<FakeStoreLoginResponse> => {
