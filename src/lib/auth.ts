import type { LoginCredentials, SignupCredentials, ValidationError } from '../types/auth'
...
export const validateSignupForm = (credentials: SignupCredentials): ValidationError[] => {
  const errors: ValidationError[] = []
